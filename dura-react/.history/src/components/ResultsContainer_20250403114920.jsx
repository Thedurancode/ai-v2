...
const Score = styled(motion.div)`
  ...
  ${({ score, theme }) => {
    if (score >= 8) return `background: linear-gradient(135deg, ${theme.colors.scoring.excellent} 0%, #00b8a9 100%);`;
    if (score >= 6) return `background: linear-gradient(135deg, ${theme.colors.scoring.good} 0%, #e72b3e 100%);`;
    if (score >= 4) return `background: linear-gradient(135deg, ${theme.colors.scoring.average} 0%, #ffb300 100%);`;
    return `background: linear-gradient(135deg, ${theme.colors.scoring.poor} 0%, #e53935 100%);`;
  }}
`;
...
const ResultsContainer = ({ results, onSelectCompany }) => {
  ...
  // Function to get the best available logo
  ...
  // Function to get the best available description
