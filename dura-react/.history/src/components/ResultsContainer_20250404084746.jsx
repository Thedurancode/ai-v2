...
const Score = styled(motion.div)`
  ...
  ${({ score }) => {
    ...
    if (score > 2 && score <= 4) return `background: #FFD700;`; // Different yellow (gold)
    if (score >= 5 && score <= 9) return `background: #32CD32;`; // Different green (lime green)
    if (score === 10) return `background: #FF4500;`;
