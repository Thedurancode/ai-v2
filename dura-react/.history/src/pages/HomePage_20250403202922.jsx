    ...
    const checkSearchStatus = async () => {
      try {
        ...
        setSearchStatus({
          ...
          current_step: 'error',
          message: 'Error checking search status: ' + (error.message || 'Unknown error'),
          completed: true
        });
      }
    };
  ...
  const handleSearch = async (query) => {
    ...
    try {
      ...
      setSearchStatus({
        ...DEFAULT_LOADING_STATUS,
        current_step: 'error',
        message: 'Error during search: ' + (error.response?.data?.message || error.message || 'Unknown error'),
        completed: true
      });
      setIsSearching(false);
    }
  ...
  const handleAiSearch = async () => {
    ...
    try {
      ...
      setSearchStatus({
        ...DEFAULT_LOADING_STATUS,
        current_step: 'error',
        message: 'Error during AI search: ' + (error.response?.data?.message || error.message || 'Unknown error'),
        completed: true
      });
      setIsSearching(false);
    }
