...
const HomePage = () => {
  ...
  const fetchHistory = async () => {
    try {
      ...
      console.warn('Error fetching search history:', error?.response?.data?.message || error.message);
  ...
  useEffect(() => {
    if (searchResults && shouldSaveResults) {
  ...
  }, [searchResults, shouldSaveResults, searchQuery]);
      ...
      <PageContainer>
        ...
        <Main>
          <SearchBox
            ...
            onClear={() => setShouldSaveResults(false)}
