...
import { deletePartner } from '../services/partnerApi.js';
...
const ResearchMetadata = styled(motion.div)`
  display: flex;
  justify-content: space-between;
  align-items: center;
  font-size: 0.75rem;
...
const ResearchSection = styled(motion.div)`
  display: flex;
  flex-direction: column;
...
const ResearchFooter = styled(motion.div)`
  font-size: 0.75rem;
  color: rgba(255, 255, 255, 0.7);
  margin-top: 1rem;
  text-align: right;
...
const PartnerDetailModal = ({ isOpen, onClose, partner, onDelete }) => {
          ...
          <ModalSection>
            ...
            <DetailGrid>
              <DetailItem>
                ...
                <DetailValue>{partner.industry || 'Unknown'}</DetailValue>
              </DetailItem>
              <DetailItem>
              ...
              >
                ...
                <div style={{ display: 'flex', gap: '1rem' }}>
                  ...
                  <motion.button
                    ...
                    whileHover={!isLoadingResearch ? { scale: 1.05 } : {}}
                    whileTap={!isLoadingResearch ? { scale: 0.98 } : {}}
                    style={{
                      display: 'flex',
                      alignItems: 'center',
                      gap: '0.5rem',
            ...
            <ModalBody style={{ paddingBottom: 0 }}>
              ...
              >
                ...
                <ActionButtonsContainer>
                  ...
                  <button onClick={handleDelete} style={{ background: 'red', color: 'white', marginRight: 8 }}>Delete</button>
                </ActionButtonsContainer>
              </ModalSection>
            </ModalBody>
